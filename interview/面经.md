...
null代表空值，undefined代表声明了但是没有被赋值

undefined不是关键字，但null是关键字（js关键字break, if, this, do, case, catch, finally, new, typeof, else, ）

undefined == null true

undefined本质上是window的一个属性，null是一个对象

undefined通常出现在： 声明变量没有赋值，函数没有设置返回值，引用没有赋值的对象属性
...
刚刚看了方应杭的关于前端发展历程的视频，涵盖了从浏览器大战，到中国企业转型互联网，再到09年左右nodejs, npm, commonjs的诞生，以及10年开始，angular, react和vue框架的兴起的过程，感觉到技术发展真的是日新月异，在当时看来非常火热的技术可能几年内就会变得无人知晓，背后本质都是利益的驱动，消费者选择了什么样的产品，影响了市场份额，以及公司保护自己的产品而推出技术壁垒和发起技术标准，还有印象很深的是，现在国内互联网的巨头最早基本都不是做这个的，阿里最早做的是中国黄页，京东是B2C的3C业务，就是面向消费者卖一些电子产品，腾讯更离谱，最早做的是bb机，然后是qq这样即时通讯软件和游戏，最后转向了互联网。
